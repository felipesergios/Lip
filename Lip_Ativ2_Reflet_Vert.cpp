...
int media = 0;
            ...
            for(int i = 0; i<img.Largura/2; i++){
                for(int j = 0; j<img.Altura; j++){

                img_out.Matriz[i][j].R = img.Matriz[img.Largura - i][j].R;
                img_out.Matriz[i][j].G = img.Matriz[img.Largura - i][j].G;
                img_out.Matriz[i][j].B = img.Matriz[img.Largura - i][j].B;
            ...
            for(int i = img.Largura/2; i<img.Largura; i++){
                for(int j = 0; j<img.Altura; j++){
