...
int media = 0;
            ...
            for(int i = 0; i<img.Largura; i++){
                ...
                img_out.Matriz[i][j].R = img.Matriz[img.Altura - i][img.Largura - j].R;
                img_out.Matriz[i][j].G = img.Matriz[img.Altura - i][img.Largura - j].G;
                img_out.Matriz[i][j].B = img.Matriz[img.Altura - i][img.Largura - j].B;
