...
void rot_direita(Img img, Img& img_out){
            ...
            for(int i = 0; i<img.Altura; i++){
                ...
                img_out.Matriz[img.Largura-i][img.Altura-j].R = img.Matriz[i][j].R;
                img_out.Matriz[img.Largura-i][img.Altura-j].G = img.Matriz[i][j].G;
                img_out.Matriz[img.Largura-i][img.Altura-j].B = img.Matriz[i][j].B;
